...
Usage:
    python -m loadtest.generate --count 1000
    python -m loadtest.generate --count 100000 --seed 42
    python -m loadtest.generate --count 10 --state Massachusetts --city Boston
