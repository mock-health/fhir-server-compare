...
def bootstrap_aidbox(run_dir: Path) -> None:
    ...
    an operator creates the backing indexes. See loadtest/aidbox_bootstrap.py
...
def _count_patients(server_id: str, servers_file: Path) -> int:
    ...
    from _fhir_servers import build_headers, find_server, load_servers, resolve_base_url
    try:
