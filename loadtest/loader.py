...
Usage:
    python -m loadtest.loader --server hapi --workers 32 --log results/hapi.jsonl
    python -m loadtest.loader --server hapi --limit 1000 --log results/hapi-stage1.jsonl
    python -m loadtest.loader --server hapi --offset 100000 --limit 1000 --log ...
"""
...
# allow `python loadtest/loader.py` as well as `python -m loadtest.loader`
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
from _fhir_servers import AuthedSession, find_server, load_servers, resolve_base_url  # noqa: E402
